...
public class AdopetConsoleApplication {
    ...
    private static void listarAbrigo() throws IOException, InterruptedException {
        ...
        HttpResponse<String> response = dispararRequsicaoGet(client, uri);
    ...
    private static HttpResponse<String> dispararRequsicaoGet(HttpClient client, String uri) throws IOException, InterruptedException {
